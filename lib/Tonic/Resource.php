...
class Resource
{
    ...
    /**
     * Get a URL parameter as defined by this resources and it's URI
    ...
    /**
     * Get the method name of the best matching resources method.
     *
    ...
    /**
     * Run resources setup actions before executing the matched resources method.
     *
     * Condition annotations applied to the setup() method will be applied to all
     * resources methods within the class.
     */
    protected function setup() {}

    /**
     * Execute the resources, that is, find the correct resources method to call
    ...
    public function exec()
    {
        ...
        // get the annotation metadata for this resources
    ...
    /**
     * Add a function to execute on the request before the resources method is called
     *
    ...
    /**
     * Add a function to execute on the response after the resources method is called
     *
     * @param callable $action The function to execute
     */
