...
class Application
{
    ...
    public function __construct($options = array())
    {
        ...
        // load resources metadata passed in via options array
        ...
        } else { // otherwise load from loaded resources files
            if (isset($options['load'])) { // load given resources class files
    ...
    /**
     * Load the metadata for all loaded resources classes
    ...
    /**
     * Get the URL for the given resources class
     *
     * @param  str   $className
     * @param  str[] $params
     * @return str
    ...
    /**
     * Given the request data and the loaded resources metadata, pick the best matching
     * resources to handle the request based on URI and priority.
     *
    ...
    /**
     * Get the already loaded resources annotation metadata
     * @param  Tonic/Resource $resources
     * @return str[]
     */
